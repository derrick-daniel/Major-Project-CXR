...
def train_model(
    ...
    Args:
        model: torchvision model to be finetuned (EfficientNet_B3 in this case)
...
def train_cnn(PATH_TO_IMAGES, LR, WEIGHT_DECAY):
    ...
    model.classifier[1] = nn.Linear(num_ftrs, N_LABELS)

    # If you are dealing with a multi-label classification, add a Sigmoid activation as well
